...
#[case("/2/activity/stream", true)]
#[case("/2/likes/compliance/stream", true)]
#[case("/2/likes/firehose/stream", true)]
#[case("/2/likes/sample10/stream", true)]
#[case("/2/tweets/compliance/stream", true)]
#[case("/2/tweets/label/stream", true)]
#[case("/2/users/compliance/stream", true)]
#[case("/2/tweets/search/stream/", true)]
