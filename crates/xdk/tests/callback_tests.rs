...
//!
//! Drives `xdk::auth::callback::wait_for_callback_with` on a worker thread's own runtime
...
use xdk::auth::callback::wait_for_callback_with;
use xdk::error::Result as XurlResult;
