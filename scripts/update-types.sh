...
#
# Reads crates/xdk/vendor/x-api-openapi.json — the same vendored snapshot build.rs
...
# against.
#
# The hand-written types in crates/xdk/src/api/response/types.rs are reviewed by hand:
...
SPEC_FILE="crates/xdk/vendor/x-api-openapi.json"
